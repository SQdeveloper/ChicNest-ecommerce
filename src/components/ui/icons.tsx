export const LinkedinkIcon = ({className}: {className?: string})=>{
    return(
...
export const AwardIcon = ({className}: {className?: string}) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" 
    className={`bi bi-award-fill ${className}`} viewBox="0 0 16 16"
  >
...
export const ShieldIcon = ({className}: {className?: string}) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" 
    className={`${className} bi bi-shield-fill-check`} 
    viewBox="0 0 16 16">
...
export const ChevronListIcon = ({className}: {className?: string}) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" 
    className={className}
  >
