...
const ButtonStyle = () => {
    return (
        <Link  
            to=''
            className="relative shadow block font-secondary text-sm w-fit text-white"
        >
            <div className="bg-brown z-20 flex gap-1 text-nowrap px-6 py-2 text-transparent rounded-[3px] justify-center items-center">
                <span>Shop Now</span>
                <ArrowLeftDown/>
            </div>
