...
const Footer = () => {
    return (
        <footer className="max-sm:w-full max-sm:flex max-sm:flex-col max-sm:px-5 max-[800px]:grid max-[800px]:grid-cols-2 bg-light-brown font-secondary px-10 py-10 flex gap-5 justify-between">
