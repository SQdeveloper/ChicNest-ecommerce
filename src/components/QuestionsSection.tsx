...
const QuestionsSection = () => {
    return (
        <div className="bg-extra-light-gray">
            <section className="max-md:py-6 px-2 max-w-[1280px] mx-auto relative text-center py-12">
                <span className="max-md:text-xl capitalize text-rat-gray font-secondary">ask us anything</span>
                <h2 className="leading-[50px] capitalize mt-3 font-primary text-4xl">frequently asked questions</h2>
