        ...
        <div className="relative text-white bg-transparent rounded-md overflow-hidden flex flex-col">
            ...
            >
                <div className="flex justify-between">
                    <h2 className="font-primary text-inherit text-[20px] ">{question}</h2>                    
                </div>
                
            </label>
            <MinusIcon className="border-white text-white peer-checked:block hidden absolute top-5 right-3 w-5 border rounded-md h-5"/>
            <PlusIcon className="text-dark-gray peer-checked:hidden absolute top-5 right-3 w-5 border border-dark-gray rounded-md h-5"/>                    
