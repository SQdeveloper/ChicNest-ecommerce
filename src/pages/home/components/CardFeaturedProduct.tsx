...
const CardFeaturedProduct: React.FC<Props> = ({product}) => {
    ...
    return (
        <aside className="font-secondary relative flex flex-col items-center px-1 justify-between bg-extra-light-gray rounded-md overflow-hidden">
            {
                isOffer &&
            ...
            />
            <div className="justify-between bg-white px-2 py-2 w-full mb-1 rounded-sm flex gap-2 items-start">
